...
public class Task extends Lesson{
    ...
    public Task(Long id, String title, Integer position, Section section, String description, Integer questionCount, Integer aprovalCount, Double weight, Instant dueDate) {
